<!--
 * @Author: li_yning 865224908@qq.com
 * @Date: 2023-04-14 10:45:33
 * @LastEditors: li_yning 865224908@qq.com
 * @LastEditTime: 2023-04-15 14:36:27
 * @FilePath: \EFP6-Vue-AntDesign\src\components\play\AliPlayer.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <div class="prism-player" :id="playerId" ref="aliplayer"></div>
</template>
<script>
export default {
  name: 'Aliplayer',
    ...
    initAliplayer () {
      ...
      if (_this.scriptTagStatus === 2 && (_this.instance === null || _this.reloadPlayer)) {
        ...
        _this.$nextTick(() => {
          let components = []
          if (_this.speedPlay) {
            let AliPlayerComponent = window.AliPlayerComponent
            components = [
              {
                name: 'RateComponent',
          ...
          _this.instance.on('canplaythrough', (e) => {
            if (_this.seekTime) {
